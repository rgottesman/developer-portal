---
title: Surfsight Developer Portal
---
...
<Jumbotron>
  ...
  <H1>Surfsight Developer Portal</H1>
  <H2>The Surfsight API developer portal</H2>
  <Flex p={20} justifyContent="center">
    {/* <Button size="xlarge" to="https://app.redoc.ly">
      Redocly app
    </Button> */}
     <Button variant="outlined" size="xlarge" to="developer-portal/surfsight-concepts.md">
      Get started
    </Button>
...
<Box my={25}>
  <SectionHeader>
    Take a look at some helpful <Emphasis> documentation </Emphasis>!
  </SectionHeader>
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile to="developer-portal/basic-authentication.md" icon={icon1} header="Authentication">
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <WideTile to="developer-portal/how-partners-add-a-new-customer.md" header="Add a new customer">
        Lorem ipsum dolor sit amet, pri putent oportere quaerendum in, ea mea justo invenire
        aliquando. Usu modo suavitate ea. Et sed labitur epicurei adipiscing. Nibh zril labitur
        an usu.
    </WideTile>
